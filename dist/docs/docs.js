...
// Import schemas
import { createTenantSchema, updateTenantSchema, tenantResponseSchema } from '../schemas/tenant.schema.js';
import { createProjectSchema, updateProjectSchema, projectResponseSchema, projectMemberOperationSchema, updateProjectMemberSchema } from '../schemas/project.schema.js';
import { createProjectTypeSchema, projectTypeResponseSchema } from '../schemas/projectType.schema.js';
import { createCloudProviderSchema, cloudProviderResponseSchema } from '../schemas/cloudProvider.schema.js';
import { createCloudProviderIntegrationSchema, cloudProviderIntegrationResponseSchema } from '../schemas/cloudProviderIntegration.schema.js';
// Create OpenAPI registry
const registry = new OpenAPIRegistry();
// Define common responses
const unauthorizedResponse = registry.registerComponent('responses', 'UnauthorizedError', {
...
const forbiddenResponse = registry.registerComponent('responses', 'ForbiddenError', {
...
const notFoundResponse = registry.registerComponent('responses', 'NotFoundError', {
...
const badRequestResponse = registry.registerComponent('responses', 'BadRequestError', {
