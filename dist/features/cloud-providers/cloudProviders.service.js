...
import { CloudProviderErrorCodes } from '../../schemas/cloudProvider.schema.js';
export class CloudProviderService {
    constructor() {
        this.collection = getDB().collection('cloudProviders');
    }
    async findAll() {
    ...
    async update(id, data, userId) {
        ...
        const result = await this.collection.findOneAndUpdate({ _id: cloudProvider._id }, { $set: updates }, { returnDocument: 'after' });
        if (!result) {
